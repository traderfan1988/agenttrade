...
def _gesamtconviction(befunde_a1: List[Befund], befunde_a2: List[Befund]) -> float:
    ...
    return round((g1 / gesamt_g) * c1 + (g2 / gesamt_g) * c2, 1)
...
def screene(ticker: str) -> dict:
    ...
    return {
        ...
        "conviction": _gesamtconviction(befunde_a1, befunde_a2),
